...
export const whyChooseUsData = [
  {
    title: "Comprehensive Fleet Expertise",
    description:
      "Our extensive fleet covers <b>flatbeds, lowbeds, pickups, and specialized chassis</b> — ensuring your oversized, heavy, and project cargo is secured with certified lashing systems.",
  },
  {
    title: "Experienced Logistics Advisors",
    description:
      "Decades of combined experience in organizing complex route surveys, UAE permits, and police escorts for super-heavy loads.",
  },
  {
  ...
  <div className="relative border-l-4 border-brand-blue ml-2 sm:ml-6">
    {data.map((item, idx) => (
      ...
      >
        ...
        >
          <h3
            className={`text-lg font-bold mb-2 uppercase tracking-wide ${isDark ? "text-slate-100" : "text-slate-900"}`}
          >
            {item.title}
          </h3>
          <p
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2
              className={`text-3xl sm:text-4xl font-extrabold tracking-tight mt-2 uppercase ${isDark ? "text-white" : "text-slate-900"}`}
            >
              Built for Reliability
            </h2>
            <p
              className={`max-w-2xl mx-auto mt-4 text-sm sm:text-base ${isDark ? "text-slate-400" : "text-slate-600"}`}
            >
              onroad overrides traditional transit inefficiencies by shipping
              direct without mid-route loading shifts.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-stretch">
            ...
            >
              <div>
                ...
                <h3
                  className={`text-xl font-bold uppercase tracking-wider mb-4 ${isDark ? "text-white" : "text-slate-900"}`}
                >
                  Direct Door-to-Door
                </h3>
                <p
                  className={`text-sm text-justify leading-relaxed ${isDark ? "text-slate-400" : "text-slate-600"}`}
                >
                  Avoid slow cargo shifts at warehouses. Your heavy components,
                  steel structures, or pipes stay secured on the exact same
                  trailer from pick-up to final delivery point. No damage risk.
                </p>
              </div>
            ...
            {/* Value Prop 2: Telemetry Visibility */}
            <div
              className={`p-8 rounded-xl border flex flex-col justify-between relative overflow-hidden ${
                isDark
                  ? "bg-slate-900/60 border-slate-800"
                  : "bg-slate-50 border-slate-200"
              }`}
            >
              <div>
                ...
                <p
                  className={`text-sm text-justify leading-relaxed mb-6 ${isDark ? "text-slate-400" : "text-slate-600"}`}
                >
                  Monitor shipments closely with our dedicated active dispatch. We verify
                  borders and load status at all transit nodes.
                </p>
              ...
              <div className="mt-8 pt-4 border-t border-slate-800 flex items-center gap-2 text-xs font-bold text-brand-blue uppercase tracking-wider">
                <FaCheckCircle /> <span>Advanced Dispatch Integration</span>
              </div>
            </div>
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p
              className={`max-w-xl mx-auto mt-4 text-sm sm:text-base ${isDark ? "text-slate-400" : "text-slate-600"}`}
            >
              What set us apart in the UAE oversized and heavy industrial
              haulage sector.
            </p>
          </div>
